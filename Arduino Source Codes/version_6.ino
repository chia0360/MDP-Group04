...
void objScan(){
  ...
  //---------------Scan Left----------------------------------------     
  //Scan Left
  if(leftSensorAvg<=24 && leftSensorAvg>0)
    objPos[0] = 1;
  else 
    objPos[0] = 0;
  ...
  //---------------Scan Front----------------------------------------    
  //Scan Front Left
  if(frontLeftSensorAvg<=14 && frontLeftSensorAvg>0)
    objPos[1] = 1;
  else 
    objPos[1] = 0;

  if(frontCentreSensorAvg<=14 && frontCentreSensorAvg>0)
    objPos[2] = 1;
  else 
    objPos[2] = 0;
    
  //Scan Front Right
  if(frontRightSensorAvg<=14 && frontRightSensorAvg>0)
    objPos[3] = 1;
  else
    objPos[3] = 0;


   if(rightSensorAvg<=14 && rightSensorAvg>0)
    objPos[4] = 1;
  else
    objPos[4] = 0;
